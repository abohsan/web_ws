...
<h3>1. Navbar Text 0</h3>
     ...
     <p id="p2">3. Use the .navbar-text class to vertical align any elements inside the navbar that are not links (ensures proper padding).</p>
     <h3><?php echo $lang['programming'];?></h3>
     
     <p><?php echo $lang['text'];?></p>
   <p>4. Use the .navbar-text class to vertical align any elements inside the navbar that are not links (ensures proper padding).</p>
